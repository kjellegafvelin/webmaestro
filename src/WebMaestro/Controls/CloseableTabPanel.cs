...
{
    public class CloseableTabPanel : Panel, IScrollInfo
    {
        ...
        private Dock TabStripPlacement
        {
            ...
            {
                Dock dock = Dock.Top;
                CloseableTabControl templatedParent = base.TemplatedParent as CloseableTabControl;
        ...
        internal static readonly DependencyProperty CanScrollLeftOrUpProperty = DependencyProperty.Register("CanScrollLeftOrUp", typeof(bool), typeof(CloseableTabPanel), new UIPropertyMetadata(false));
        ...
        internal static readonly DependencyProperty CanScrollRightOrDownProperty = DependencyProperty.Register("CanScrollRightOrDown", typeof(bool), typeof(CloseableTabPanel), new UIPropertyMetadata(false));
        ...
        private Size MeasureHorizontal(Size availableSize)
        {
            ...
            {
                CloseableTabItem tabItem = InternalChildren[i] as CloseableTabItem;
        ...
        public Rect MakeVisible(Visual visual, Rect rectangle)
        {
            ...
            CloseableTabControl ic = ItemsControl.GetItemsOwner(this) as CloseableTabControl;
        ...
        private static void SetDimensions(CloseableTabItem tabItem)
        {
